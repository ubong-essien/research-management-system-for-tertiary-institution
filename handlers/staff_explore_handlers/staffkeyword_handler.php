...
<div class="row">
			...
			if(!isset($_POST['currentpage']) && isset($_POST['s_criteria'])){
				//echo "post1";
					...
					$fq=getAllRecord($con,"staff_submission","topic LIKE '$keyword%' OR topic LIKE '%$keyword%'","date_uploaded DESC","");
					//var_dump($r);
					...
					//echo "offset".$offset;
					$r=getAllRecord($con,"staff_submission","topic LIKE '$keyword%' OR topic LIKE '%$keyword%'","date_uploaded DESC","$offset,$rowsperpage");
					/*   $pagConfig = array(
											'currentPage' => $start,
											'totalRows' => $rowCount,
											'perPage' => $limit,
